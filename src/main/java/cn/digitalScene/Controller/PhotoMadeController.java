...
public class PhotoMadeController {
    ...
    public String toAppointList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        return "page/admin/module/photoMade/toAppointList";
    }
    ...
    public String toDealWithList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        return "page/admin/module/photoMade/toDealWithList";
    }
    ...
    public Object toAccept(Integer id){
        try {
            //3为球形图制作模块的状态：进行中；1为球形图制作模块is_photoMadePeople确认接受状态
            projectService.updatePhotoMadeStatusAndAcceptById(id,3,1);
    ...
    public Object toReject(Integer id,String photoMadePeopleReason){
        try {
            //1为球形图制作模块的状态：待确认；2为球形图制作模块is_photoMadePeople拒绝状态
            projectService.updatePhotoMadeStatusAndRejectById(id,1,2,photoMadePeopleReason);
            return executeResult.jsonReturn(200);
        } catch (Exception e) {
    ...
    public String toDealWith(Integer photoMadeId,Model model){
        ...
        return "/page/admin/module/photoMade/toDealWith";
    }
    ...
    public Object toDealWithFinish(Integer id){
        try {
            ...
            projectService.updatePhotoMadeStatusAndDealWithById(id,4,toDealWithFinishDate);
            return executeResult.jsonReturn(200,false);
        } catch (Exception e) {
            return executeResult.jsonReturn(300,e.getMessage(),false);
        }
    ...
    public String toCheckList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        return "/page/admin/module/photoMade/toCheckList";
    }
    ...
    public Object toCheckFinish(Integer id,HttpSession session){
        try {
            ...
            //5为球形图制作状态为已完成，同时启动场景制作模块状态，1为待指派
            projectService.updatePhMaStatusToCheckFinishById(id,5,1,checkPeople,toCheckDate);
            return executeResult.jsonReturn(200,false);
        } catch (Exception e) {
            return executeResult.jsonReturn(300,e.getMessage(),false);
        }
    ...
    public String toFinishList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        return "/page/admin/module/photoMade/finishList";
    }
