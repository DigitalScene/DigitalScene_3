...
public class Mp3EditController {
    ...
    public String toAppointList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        try {
            ...
            projectsList=projectService.findAllByIsDel0(projectName,createTime,null,null,null,null,null,null,"1",null,null,null,null,null,orderField,orderDirection,pageRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String toCheckList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        try {
            ...
            projectsList=projectService.findAllByIsDel0(projectName,createTime,null,null,null,null,null,null,"4",null,null,null,null,null,orderField,orderDirection,pageRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String toFinishList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        try {
            ...
            projectsList=projectService.findAllByIsDel0(projectName,createTime,null,null,null,null,null,null,"5",null,null,null,people,moduleType,orderField,orderDirection,pageRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
