...
public class ThrDModelMadeController {
    ...
    public String toAppointList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        try {
            ...
            projectsList=projectService.findAllByIsDel0(projectName,createTime,null,null,null,null,null,null,null,null,"1",null,orderField,orderDirection,pageRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String toDealWithList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        try {
            ...
            projectsList=projectService.findAllByIsDel0(projectName,createTime,null,null,null,null,null,null,null,null,"2,3",null,orderField,orderDirection,pageRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String toCheckList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        try {
            ...
            projectsList=projectService.findAllByIsDel0(projectName,createTime,null,null,null,null,null,null,null,null,"4",null,orderField,orderDirection,pageRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String toFinishList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        try {
            ...
            projectsList=projectService.findAllByIsDel0(projectName,createTime,null,null,null,null,null,null,null,null,"5",null,orderField,orderDirection,pageRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
