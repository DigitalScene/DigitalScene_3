...
public class SceneMadeController {
    ...
    public String toAppointList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        try {
            ...
            projectsList=projectService.findAllByIsDel0(projectName,createTime,null,"5","5","5","1",null,null,null,null,null,null,null,orderField,orderDirection,pageRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String toDealWithList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        try {
            ...
            projectsList=projectService.findAllByIsDel0(projectName,createTime,null,"5","5","5","2,3",null,null,null,null,null,people,"sceneMade",orderField,orderDirection,pageRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String toDealWith(Integer sceneMadeId,Model model){
    ...
    public String toCheckList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        try {
            ...
            projectsList=projectService.findAllByIsDel0(projectName,createTime,null,"5","5","5","4",null,null,null,null,null,null,null,orderField,orderDirection,pageRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String toFinishList(@RequestParam(value = "projectName",required = false)String projectName,
        ...
        try {
            ...
            projectsList=projectService.findAllByIsDel0(projectName,createTime,null,"5","5","5","5",null,null,null,null,null,people,moduleType,orderField,orderDirection,pageRequest);
        } catch (Exception e) {
            e.printStackTrace();
        }
