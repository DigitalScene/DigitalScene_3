...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${pageContext.request.contextPath}/admin/mp3Edit/toFinishList" method="post">
    ...
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        ...
        <c:forEach var="list" items="${finishList.content}" varStatus="i">
            <tr >
                ...
                <td class="project">${list.mp3Edit.mp3EditToCheckPeople}</td>
                <td class="project">${list.mp3Edit.getMp3EditCheckDateStr()}</td>
                <td class="project">${list.getMp3EditStatus()}</td>
                <td class="project">${list.getProjectStatus()}</td>
                <td class="project">
                    <a href="${pageContext.request.contextPath}/admin/mp3Edit/toCheck?mp3EditId=${list.mp3Edit.id}" class="btn btn-info" data-toggle="dialog" data-width="500" data-height="300" data-id="dialog-mask" data-mask="true">查看详情</a>
                </td>
            </tr>
        </c:forEach>
