...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${pageContext.request.contextPath}/admin/photoEdit/toAppointList" method="post">
    ...
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        ...
        <c:forEach var="list" items="${appointList.content}" varStatus="i">
            <tr >
                ...
                <td class="project">${list.photoEdit.photoEditPeople_reason}</td>
                <td class="project">${list.getProjectStatus()}</td>
                <td class="project">
                    <a href="${pageContext.request.contextPath}/admin/common/module/toAppoint?id=${list.id}&type=photoEdit" class="btn btn-info" data-toggle="dialog" data-width="500" data-height="160" data-id="dialog-mask" data-mask="true">指派</a>
                </td>
            </tr>
        </c:forEach>
