...
<div class="bjui-pageContent">
     <form action="${pageContext.request.contextPath}/admin/photoEdit/toReject" data-toggle="validate" data-reload-navtab="true" method="post">
                       ...
                       <tr>
                           <td colspan="2">
                               ...
                               <div style="display: inline-block;vertical-align: middle;">
                                   <textarea name="photoEditPeopleReason" data-rule="required" data-rule-*="[^[\u4e00-\u9fa5]{1,50}$,'请低于50字']"  style="width:440px;height:50px"></textarea>
                               </div>
                           </td>
                       </tr>
                       <tr>
