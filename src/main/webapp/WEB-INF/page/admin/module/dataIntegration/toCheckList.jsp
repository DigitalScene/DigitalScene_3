...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${pageContext.request.contextPath}/admin/dataIntegration/toCheckList" method="post">
...
<div class="bjui-pageContent">
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        ...
        <tr>
            ...
            <th class="project">数据整合者</th>
            <th class="project" style="width: 90px;">整合完成时间</th>
        ...
        <c:forEach var="list" items="${checkList.content}" varStatus="i">
            <tr >
                ...
                <td class="project">${list.dataIntegration.getDataIntegrationFinishDateStr()}</td>
                <td class="project">${list.getDataIntegrationStatus()}</td>
                <td class="project">${list.getProjectStatus()}</td>
                <td class="project">
                    <a href="${pageContext.request.contextPath}/admin/dataIntegration/toCheck?dataIntegrationId=${list.dataIntegrationId.id}" class="btn btn-info" data-toggle="dialog" data-width="500" data-height="300" data-id="dialog-mask" data-mask="true"  >审核</a>
                    <a href="${pageContext.request.contextPath}/admin/dataIntegration/toCheckFinish?id=${list.id}" class="btn btn-default" data-toggle="doajax" data-confirm-msg="确定要审核完成吗？" >审核完成</a>
                </td>
            </tr>
        </c:forEach>
