...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${pageContext.request.contextPath}/dataIntegration/toAppointList" method="post">
    ...
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        ...
        <c:forEach var="list" items="${appointList.content}" varStatus="i">
            <tr >
                ...
                <td class="project">
                    <a href="${pageContext.request.contextPath}/common/module/toAppoint?id=${list.id}&type=dataIntegration" class="btn btn-info" data-toggle="dialog" data-width="500" data-height="160" data-id="dialog-mask" data-mask="true">指派</a>
                </td>
            </tr>
        </c:forEach>
