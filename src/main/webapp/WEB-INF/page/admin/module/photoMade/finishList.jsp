    ...
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        ...
        <c:forEach var="list" items="${finishList.content}" varStatus="i">
            <tr >
                ...
                <td class="project">${list.photoMade.photoMadeToCheckPeople}</td>
                <td class="project">${list.photoMade.getPhotoMadeCheckDateStr()}</td>
                <td class="project">${list.getPhotoMadeStatus()}</td>
                <td class="project">${list.getProjectStatus()}</td>
                <td class="project">
                    <a href="${pageContext.request.contextPath}/admin/photoMade/toCheck?photoMadeId=${list.photoMade.id}" class="btn btn-info" data-toggle="dialog" data-width="500" data-height="300" data-id="dialog-mask" data-mask="true">查看详情</a>
                </td>
            </tr>
        </c:forEach>
